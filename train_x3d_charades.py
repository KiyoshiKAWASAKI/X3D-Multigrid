...
CHARADES_ROOT = "/data/jin.huang/UCF101"
CHARADES_ANNO = "/data/jin.huang/ucfTrainTestlist/classInd.txt"
CHARADES_DATASET_SIZE = {'train':1900, 'val':1850}
...
def run(init_lr=INIT_LR, max_epochs=100, root=CHARADES_ROOT, anno=CHARADES_ANNO, batch_size=BS*BS_UPSCALE):
    ...
    # TODO: what is inside this fucntion
